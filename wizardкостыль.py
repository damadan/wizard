...
```json
{
  "report_type": "Бухгалтерский баланс" или "Отчет о финансовых результатах" или "Полная отчетность",
  "report_year": "2023",
  "company_info": {
    "name": "ООО КОМПАНИЯ",
    "inn": "1234567890"
...
- Рассчитай ВСЕ финансовые коэффициенты:
  ...
  * Debt/Equity (долг/капитал) = Обязательства / Капитал
  * Profit Margin (рентабельность продаж) = Чистая прибыль / Выручка
...
Создай таблицу из `analysis.key_metrics`:

| Показатель | Значение | Норма |
|------------|----------|-------|
| Рост выручки | {{revenue_growth}} | >5% |
| Рентабельность продаж | {{profit_margin}} | >10% |
...
#### Баланс (сводная таблица по всем годам):
...
#### Финансовые результаты (сводная таблица):
...
**Анализ:**
- Динамика показателей (рост/падение)
- Финансовые коэффициенты (рентабельность, ликвидность)
- Ключевые выводы
