...
ТРЕБОВАНИЯ:
1. Используй эмодзи для визуализации
2. Все таблицы в markdown
3. Обязательно построй Mermaid диаграмму структуры владения
4. Будь конкретен, используй цифры и факты
5. Выдели риски жирным шрифтом
6. Дай четкие выводы и рекомендации
"""
